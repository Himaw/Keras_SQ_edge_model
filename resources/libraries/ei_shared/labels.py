...
class BoundingBox(object):
    ...
    def clip_0_1(self):
        ...
        return BoundingBox(clip01(self.x0), clip01(self.y0),
                           clip01(self.x1), clip01(self.y1))
    ...
    def from_grouth_truth_samples_dict(
        ...
        for sample in samples:
            ...
            for bb in sample['boundingBoxes']:
                ...
                if bb['h'] == 0 or bb['w'] == 0:
                    continue
                bbox = (BoundingBox.from_x_y_h_w(
                                bb['x'], bb['y'], bb['w'], bb['h'])
                        .transpose_x_y()
                        .project(1./img_width, 1./img_height)
                        .clip_0_1())
    ...
    def from_detections_samples_dict(samples: List[dict]):
        ...
        for sample in samples:
            ...
            if len(set([len(bboxes), len(labels), len(scores)])) != 1:
                raise Exception("Expected 'boxes', 'labels', 'scores' to"
